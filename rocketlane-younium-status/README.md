...
6. **Project action buttons** (v1.6.4) — light outline pills left of **Responsible**; fast inject (does not wait on nav chips). Zendesk, Oneflow, Younium, HubSpot, Rocketlane, Files, Order info, PANG, BAF. Edit/Remove stay tracker-only.
