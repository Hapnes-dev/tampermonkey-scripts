...
6. **Project action buttons** (v1.6.6) — light outline pills left of **Responsible**, plus **🔎 Fetch URLs** left of **Present** on the Secondary flex row (not inside Present’s 32px wrapper).
