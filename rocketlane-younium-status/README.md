...
6. **Project action buttons** (v1.6.5) — light outline pills left of **Responsible**, plus **🔎 Fetch URLs** left of **Present** (PPT Find-style; re-reads IQC / Deal Description / Delivery status, Oneflow plant search when empty).
