...
6. **Project action buttons** (v1.6.3) — light outline pills left of **Responsible** (no black fill): Zendesk, Oneflow, Younium, HubSpot, Rocketlane, Files, Order info, PANG, BAF. Compact row. Links from IQC / Deal Description / Delivery status. Edit/Remove stay tracker-only.
