...
- **[AI-AGENT-INSTRUCTIONS.txt](AI-AGENT-INSTRUCTIONS.txt)** — the same contract compressed for the M365 Copilot Studio instructions field (7,971 chars, no angle brackets — the field rejects `<`/`>` and caps at 8000).
